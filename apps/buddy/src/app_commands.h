...
// SINGLE-TU HEADER: include from main.cpp only (after stats.h / buddy.h /
// character.h) — it holds file-static state and reaches into stats.h inlines.
#include <LittleFS.h>
#include "line_bus.h"
#include "file_push.h"
...
// if consumed (caller skips state-update parsing). Preserves the original
// xfer.h quirk exactly: with no transfer active, unknown cmds are swallowed
// EXCEPT "permission", which falls through to state parsing.
